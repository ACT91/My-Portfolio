  ...
  return (
    <header className="fixed top-0 w-full z-50">
      <nav className="max-w-[1300px] mx-auto w-full px-4 flex mt-4">
        <div className="flex justify-between w-full max-w-[1200px] mx-auto bg-white/80 dark:bg-neutral-900/80 backdrop-blur-lg items-center p-3 rounded-full border border-white/20 dark:border-white/10 shadow-lg">
          {/* Logo / Title */}
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Theme toggle (kept) */}
            <label className="hidden lg:inline-flex swap swap-rotate p-2 rounded-full cursor-pointer theme-toggle-red">
