      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting) {
            ...
            console.log('Animation started - Contact section visible');
          } else {
            contactBtnRef.current.classList.remove('animate-border');
            console.log('Animation stopped - Contact section not visible');
          }
        });
      },
  ...
  return (
    <header className="fixed top-0 w-full z-50">
      <nav className="max-w-[1300px] mx-auto w-full px-4 flex mt-4">
        <div className="flex justify-between w-full max-w-[1200px] mx-auto bg-white/80 dark:bg-neutral-900/80 backdrop-blur-lg items-center p-4 rounded-full border border-white/20 dark:border-white/10 shadow-lg">
          {/* Logo / Title */}
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Theme toggle (kept) */}
            <label className="hidden lg:inline-flex swap swap-rotate p-2 rounded-full hover:bg-white/10 dark:hover:bg-white/5 cursor-pointer">
            ...
            <button
              ...
              className="lg:hidden transition-all duration-300 p-2 rounded-full hover:bg-[#1e3a8a]/10"
            >
              {/* bars / x icon */}
              {isMenuOpen ? (
      ...
      {/* Mobile dropdown */}
      {isMenuOpen && (
        <div className="lg:hidden fixed top-24 right-4 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-lg border border-white/20 dark:border-white/10 rounded-2xl shadow-2xl p-6 w-64 z-[60]">
